      ...
      <div className="flex justify-between items-center mb-8">
        ...
        {user && (
          <button
            ...
            className="inline-flex items-center gap-2 bg-[#5C5470] hover:bg-[#352F44] text-white font-medium px-5 py-2.5 rounded-xl shadow-md transition-all duration-300 transform hover:scale-105"
          >
            <svg
              className="w-5 h-5"
              fill="none"
