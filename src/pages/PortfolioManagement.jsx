  ...
  <div className="container mx-auto px-4 py-8 max-w-6xl">
    {hasPortfolio ? (
      <div className="space-y-8">
        ...
        <div className="relative bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-2xl border border-gray-700/50 hover:border-gray-600/50 transition-all duration-300 group">
          {/* Top-right buttons */}
          <div className="absolute top-4 right-4 flex gap-3 z-10">
            <button
              onClick={() => navigate(`/blog/edit/portfolio/${id}`)}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-500/30 border border-blue-500/40 text-blue-100 text-sm font-medium hover:bg-blue-500/40 hover:text-white transition-transform hover:scale-105"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-red-500/30 border border-red-500/40 text-red-100 text-sm font-medium hover:bg-red-500/40 hover:text-white transition-transform hover:scale-105"
            >
          ...
          >
            <div className="flex flex-col md:flex-row gap-6 md:gap-8">
              ...
              <div className="flex-1 space-y-6">
                <div>
                  <h2 className="text-3xl font-bold group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-400 group-hover:bg-clip-text transition-all duration-300">
    ...
    <div className="bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-8 relative border border-gray-700/50 animate-in zoom-in-95 duration-200">
      ...
      <div className="text-center py-20">
        ...
        <button
          ...
          className="mt-6 px-6 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium shadow"
        >
          Create Portfolio
        </button>
      </div>
