...
const BlogDetailPage = () => {
  ...
  const handleAddComment = async (e) => {
    ...
    try {
      ...
      const response = await blogService.addCommentToBlog(id, payload);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto">
        ...
        {/* Article Footer */}
        <div className="border-t border-gray-200 px-4 sm:px-6 py-10 bg-white">
          <div className="max-w-3xl mx-auto space-y-12">
                  ...
                  {shareDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-20">
                      <div className="py-2">
                        ...
                        {copied && (
                          <div className="px-4 py-1 text-green-600 text-sm font-medium">
                            ✅ Copied!
                          </div>
                        )}
            ...
            <div>
              ...
              <input
                ...
                className="border border-gray-300 rounded-lg px-3 py-2 w-full mb-3 focus:outline-none focus:ring-2 focus:ring-gray-400  text-gray-900"
              />
              ...
              <form onSubmit={handleAddComment} className="mb-6">
                <textarea
                  ...
                  className="w-full border border-gray-300 rounded-lg p-3 mb-2 focus:outline-none focus:ring-2 focus:ring-gray-400  text-gray-900"
                  rows="4"
                />
                <button
                  type="submit"
              ...
              <div className="space-y-4">
                {comments.length > 0 ? (
                  comments.map((comment, index) => (
                    <div
                      key={index}
                      className="rounded-xl bg-white  text-gray-700 shadow-sm border border-gray-200 p-4"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        {/* <button
                          ...
                          className="text-xs px-2 py-1 bg-red-100 dark:bg-red-800 text-red-600 dark:text-red-100 rounded hover:bg-red-200 dark:hover:bg-red-700 transition"
                        >
                          Delete
                        </button> */}
                      </div>
